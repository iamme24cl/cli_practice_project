...
require "cli_project_practice/version"

Gem::Specification.new do |spec|
  spec.name          = "cli_project_practice"
  spec.version       = CliProjectPractice::VERSION
  spec.authors       = ["'Chandra Lama'"]
  spec.email         = ["'iamme24cl@gmail.com'"]

  spec.summary       = %q{just practicing}
  spec.description   = %q{just practicing before the project}
